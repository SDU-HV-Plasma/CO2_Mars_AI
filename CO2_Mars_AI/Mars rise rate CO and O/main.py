...
# 优化器最小化损失函数
train_step1 = tf.train.AdamOptimizer(0.00002).minimize(loss1)
...
with tf.Session() as sess:
    ...
    for i in range(500001):
        ...
        if i % 100 == 0:
            print(sess.run(loss1, feed_dict={xs1: xa_data, ys1: ya_data}), (i/500001) * 100, '%')
