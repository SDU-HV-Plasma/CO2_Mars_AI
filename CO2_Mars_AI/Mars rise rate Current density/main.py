...
# 优化器最小化损失函数
train_step1 = tf.train.AdamOptimizer(0.00001).minimize(loss1)
train_step2 = tf.train.AdamOptimizer(0.00001).minimize(loss2)
train_step12 = tf.train.AdamOptimizer(0.001).minimize(loss12)
train_step22 = tf.train.AdamOptimizer(0.001).minimize(loss22)
      ...
      if is_mod:
       if is_mod2:
        ...
        saver.save(sess, 'save1/model1', global_step=i + 1)
           ...
           for i in range(10001):
               ...
               if i % 100 == 0:
                   print(sess.run(loss12, feed_dict={xs12: xb_data, ys12: yb_data}), (i/10001)*100, '%')
       ...
       if is_mod2:
        ...
        for i in range(10000001):
         ...
         if i % 100 == 0:
          print(sess.run(loss2, feed_dict={xs2: xc_data, ys2: yc_data}), (i/10000001)*100, '%')
        ...
        saver.save(sess, 'save2/model2', global_step=i + 1)
           ...
           for i in range(10001):
               ...
               if i % 100 == 0:
                   print(sess.run(loss22, feed_dict={xs22: xd_data, ys22: yd_data}), (i/10001)*100, '%')
